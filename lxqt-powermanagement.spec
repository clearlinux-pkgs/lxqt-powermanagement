...
Version  : 0.14.0
Release  : 1
URL      : https://downloads.lxqt.org/downloads/lxqt-powermanagement/0.14.0/lxqt-powermanagement-0.14.0.tar.xz
Source0  : https://downloads.lxqt.org/downloads/lxqt-powermanagement/0.14.0/lxqt-powermanagement-0.14.0.tar.xz
...
%prep
%setup -q -n lxqt-powermanagement-0.14.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1549558773
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
