...
Version  : 1.2.0
Release  : 13
URL      : https://github.com/lxqt/lxqt-powermanagement/releases/download/1.2.0/lxqt-powermanagement-1.2.0.tar.xz
Source0  : https://github.com/lxqt/lxqt-powermanagement/releases/download/1.2.0/lxqt-powermanagement-1.2.0.tar.xz
Source1  : https://github.com/lxqt/lxqt-powermanagement/releases/download/1.2.0/lxqt-powermanagement-1.2.0.tar.xz.asc
...
%prep
%setup -q -n lxqt-powermanagement-1.2.0
cd %{_builddir}/lxqt-powermanagement-1.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667857197
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/lxqt-powermanagement-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/lxqt-powermanagement/7fab4cd4eb7f499d60fe183607f046484acd6e2d || :
pushd clr-build
%make_install
popd
...
/usr/share/lxqt/translations/lxqt-config-powermanagement/lxqt-config-powermanagement_et.qm
...
/usr/share/lxqt/translations/lxqt-config-powermanagement/lxqt-config-powermanagement_ko.qm
...
/usr/share/lxqt/translations/lxqt-powermanagement/lxqt-powermanagement_et.qm
...
/usr/share/lxqt/translations/lxqt-powermanagement/lxqt-powermanagement_hr.qm
...
/usr/share/lxqt/translations/lxqt-powermanagement/lxqt-powermanagement_ko.qm
...
/usr/share/lxqt/translations/lxqt-powermanagement/lxqt-powermanagement_vi.qm
