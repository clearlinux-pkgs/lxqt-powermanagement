...
Version  : 1.1.0
Release  : 12
URL      : https://github.com/lxqt/lxqt-powermanagement/releases/download/1.1.0/lxqt-powermanagement-1.1.0.tar.xz
Source0  : https://github.com/lxqt/lxqt-powermanagement/releases/download/1.1.0/lxqt-powermanagement-1.1.0.tar.xz
Source1  : https://github.com/lxqt/lxqt-powermanagement/releases/download/1.1.0/lxqt-powermanagement-1.1.0.tar.xz.asc
...
%prep
%setup -q -n lxqt-powermanagement-1.1.0
cd %{_builddir}/lxqt-powermanagement-1.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650312491
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/lxqt-powermanagement-1.1.0/LICENSE %{buildroot}/usr/share/package-licenses/lxqt-powermanagement/7fab4cd4eb7f499d60fe183607f046484acd6e2d
pushd clr-build
%make_install
popd
